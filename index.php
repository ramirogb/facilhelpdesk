...
if ($_GET['action']=='trans')
{
 ...
 $jump_here="Location: ".'./tickets.php?action=open&ticketid='.$_POST['ticketid'].'&key3='.$_POST['key3'];	      
  header($jump_here); 
exit;
}
...
if (  isset($_POST['name']) and  isset($_POST['password'] ) )
{
 {				 $_SESSION['xcv_userna'] = $_POST['name'];
                 ...
                 $jump_here="Location: ".'./tickets.php';	
                 header($jump_here); 
                 exit;
}          
...
<table  style="border-color: #8F97EF; border-width:1px; border-style:solid " width="50%" align="center" cellpadding="0" cellspacing="0" class="boxborder">
  ...
  <tr>
    <td width="27%" height="32"  valign="top"  bgcolor="#0033CC"  style="padding-top:4px "><span style="font-family: Arial, Helvetica, sans-serif; color: #FFFFFF"><span style="font-family: Arial, Helvetica, sans-serif; color: #FFFFFF"><span class="text"><span class="comment2">
      <?php if ($logo_url<>''){ ?>
      <img src="<?php echo $logo_url;  ?>"alt="<?php echo $logo_url; ?>" hspace="2" vspace="2"  longdesc="Facil Help Desk">
      <?php } echo $last_msg;?>
    </span></span></span></span>      </td>
    <td width="73%"  valign="top"  bgcolor="#0033CC"  style="padding-top:4px "><div align="center" class="man">
      <h5><a href="index.php?action=register"><?php if ($disable_registering<>'TRUE' )  { ?>Register</a><span class="Estilo3"> |<?php } ?></span> <a href="index.php?action=track">Track ticket</a> <span class="Estilo3">|</span> <a href="kbase/kbase.php">Articles</a> <a href="index.php?action=track"><span class="Estilo3">|</span></a> <a href="index.php?action=help">Help</a> <span style="font-family: Arial, Helvetica, sans-serif; color: #FFFFFF"><a href="index.php?action=register"><span style="font-family: Arial, Helvetica, sans-serif; color: #FFFFFF"></span></a></span></h5>
    </div></td>
    <?php
  ...
  <tr>
    <td colspan="2"  valign="top" bgcolor="#F5F5F5" class="mio"  style="padding:0">
	  ...
	  filter:progid:DXImageTransform.Microsoft.Alpha( Opacity=90, FinishOpacity=30, Style=2, StartX=40,  FinishX=90, StartY=50, FinishY=100);
	   left: 0px;"><span class="text" style="color: #FFFFFF"><a href="http://www.cromosoft.com">Facil HelpDesk &copy; Cromosoft Technologies 2003-2010</a><span style="font-family: Arial, Helvetica, sans-serif; color: #FFFFFF"><span style="font-family: Arial, Helvetica, sans-serif; color: #FFFFFF"><span style="font-family: Arial, Helvetica, sans-serif; color: #FFFFFF"><img src="images/logo-facil-helpdesk.png" alt="Facil HelpDesk" width="100" height="30" hspace="5" border="0" align="left"></span></span></span> <span style="font-family: Arial, Helvetica, sans-serif; color: #FFFFFF"> </span></span> </DIV>        </td>
  </tr>
  <tr>
  ...
  <tr>
    <td><form action="<?php echo $_SERVER['SCRIPT_NAME']; ?>?action=ad_user" method="post" name="form2" id="form2" onSubmit="MM_validateForm('newname','','R','username','','R','email','','RisEmail','newpassword','','R');return document.MM_returnValue" >
      <table width="100%" style="border-color: #8F97EF; border-width:1px; border-style:solid " align="center" cellpadding="1" cellspacing="1" bgcolor="#F5F5F5">
        <tr>
          <td bgcolor="#0033CC" class="text"><h4><span style="font-family: Arial, Helvetica, sans-serif; color: #FFFFFF"><span style="font-family: Arial, Helvetica, sans-serif; color: #FFFFFF"><img src="images/logo-facil-helpdesk.png" alt="Facil HelpDesk" width="100" height="30"></span> <?php echo $createaccount; ?>
          </span></h4></td>
        </tr>
        <tr >
	...
	echo $_SESSION['hlast_state'];
	 ?>
	  ...
	  filter:progid:DXImageTransform.Microsoft.Alpha( Opacity=90, FinishOpacity=30, Style=2, StartX=40,  FinishX=90, StartY=50, FinishY=100);
	   left: 1px;"><span class="text" style="color: #FFFFFF"> <a href="http://www.cromosoft.com">&copy; Cromosoft Technologies 2003-2013</a> </span> Facil Help Desk</DIV>
...
<form action="<?php echo $_SERVER['SCRIPT_NAME']; ?>?action=send_login2" method="post" name="form3" id="form3" onSubmit="MM_validateForm('email','','RisEmail');return document.MM_returnValue">
  ...
  <table  style="border-color: #8F97EF; border-width:1px; border-style:solid " width="500" align="center" cellpadding="1" cellspacing="1" bgcolor="#F5F5F5">
    <tr>
      <td bgcolor="#0033CC" class="mio"><strong><span style="font-family: Arial, Helvetica, sans-serif; color: #FFFFFF"><img src="images/logo-facil-helpdesk.png" alt="Facil HelpDesk" width="100" height="30"></span> <span class="Estilo3"><?php echo $send_login; ?></span></strong></td>
    </tr>
    <tr>
...
?>
<?php 
if (   $_GET['action']=='track'  ) //first step
{
IsOnline();
?>
<form action="<?php echo $_SERVER['SCRIPT_NAME']; ?>?action=trans" method="post" name="form3" id="form3" >
  <p>&nbsp;</p>
  <table width="500" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#F5F5F5"  style="border-color: #8F97EF; border-width:1px; border-style:solid ">
    <tr>
      <td width="101" bgcolor="#0033CC" class="mio"><strong><span style="font-family: Arial, Helvetica, sans-serif; color: #FFFFFF"><img src="images/logo-facil-helpdesk.png" alt="Facil HelpDesk" width="100" height="30"></span></strong></td>
      <td width="344" bgcolor="#0033CC" class="mio"><strong> <span class="Estilo3"><?php echo $track_unregistered; ?></span></strong></td>
    </tr>
    <tr>
      <td height="34" colspan="2" class="text"><span class="mio"><label for="email">Ticket ID:</label>
        <input name="ticketid" id="ticketid" size="10">
      </span></td>
    </tr>
    <tr>
      <td colspan="2" align="center"  class="text"><p>Ticket Key:<span class="mio">
          <input name="key3" id="key3" size="6">
      </span></p></td>
    </tr>
    <tr>
      <td height="27" colspan="2" align="center"  class="comment"><span class="mio Estilo2"> </span></td>
    </tr>
    <tr>
    ...
    <tr>
      <td   style="padding:3px " colspan="2"> <span class="comment4"><strong><?php echo $track_unregistered2; ?></strong></span><span class="mio"><br>
      </span></td>
    </tr>
  </table>
</form>
...
<form action="" method="post" name="form3" id="form3" >
  ...
  <table width="500" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#F5F5F5"  style="border-color: #8F97EF; border-width:1px; border-style:solid ">
    <tr>
      <td width="101" bgcolor="#0033CC" class="mio"><strong><span style="font-family: Arial, Helvetica, sans-serif; color: #FFFFFF"><img src="images/logo-facil-helpdesk.png" alt="Facil HelpDesk" width="100" height="30"></span></strong></td>
      <td  style="padding-top:5px" width="344" bgcolor="#0033CC" class="mio"><h4><strong class="Estilo3"> Help </strong></h4></td>
    </tr>
    <tr>
