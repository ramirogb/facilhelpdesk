...
?>
  <form action="<?php echo $_SERVER['PHP_SELF'] ?>?action=update_levels" Method="post">
    <tr bgcolor="<?php echo UseColor() ?>">
      ...
      <td class="boxborder"><input name="order" value="<?php echo $row['orderx'] ?>" size="20" /></td>
...
<form action="<?php echo $_SERVER['PHP_SELF'] ?>?action=update_levels" method="post">
  <table width="50%" align="<?php echo $maintablealign ?>" cellpadding="1" cellspacing="1" class="boxborder">
    <tr>
      <td class="text">Deleting a urgency level will make  inaccessible  to all tickets with that level <br />
      <table width="300" cellpadding="0" cellspacing="0" align="center">
        <tr>
          <td colspan="2" class="text">Create new level </td>
          </tr>
        <tr>
        ...
        <tr>
          <td class="text" colspan="2"><input name="insertlevel" type="hidden" id="insertlevel" value="1"></td>
        </tr>       
      </table>
      </td>
    </tr>
