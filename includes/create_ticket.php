        ...
        <tr>
          <td  width="50%" valign="top" style="padding-top:5px"><table    width="100%" cellspacing="2" cellpadding="0"  >
              ...
              <tr>
                ...
                <td class="text"><label id="name"><?php echo $namey; ?>:</label>
                    <input name="name" size="30" value="<?php echo $row['name'] ?>" /></td>
              </tr>
              <tr>
                <td  style="padding-left:10px " class="text"></td>
                <td class="text"><label  id="email" >Email:</label>
...
?>
        <td  style="padding-left:10px " class="text"><?php 
          ...
          <input name="fromform" type="hidden" id="fromform" value="1"> <?php } ?></td>
            <td class="text"><label id="ticketsubject"><?php echo $subx; ?>:</label>
                <input name="ticketsubject" size="30"></td>
        </tr>
        <tr>
          <td  style="padding-left:10px " class="text"></td>
          <td style="padding-left:10px " class="text"><label id="category"><?php echo $departament; 
...
?>
        ...
        <tr>
          <td style="padding-left:10px "  class="text"></td>
          <td class="text"><label id="category"><?php echo $text_listurg; ?>:</label>
              <select name="urgency">
                <?php
