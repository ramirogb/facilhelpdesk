...
.ListView{ font-family:Verdana, Arial, Helvetica, sans-serif;
 font-size: x-small; color:#333333; background-color:#DAF1FE;
}
...
.urglev{
border-spacing:0px; font-size:x-small;border-spacing:0px; border-width:1px;
}
...
padding:20px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size: smaller;
 ...
 .tables
 { border-color:#E1EBFD; border-width:1px; border-style:solid;
