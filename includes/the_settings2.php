  ...
  <table width="70%"  border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <p>&nbsp;</p>
        ...
        <table width="800" border="0" cellpadding="1" cellspacing="0" class="text">
          <tr>
          ...
          <tr>
            ...
            <td colspan="3"><div align="center"><a href="#colors" class="titulo">Colors</a></div>              <div align="center"></div>              <div align="center"></div></td>
          ...
          <tr>
            ...
            <td><a href="#notifications" class="titulo">Notifications</a></td>
            <td colspan="3">&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
        </table>
...
<fieldset>
  ...
  <br>
            ...
            <p>
              <label   for="uploadpath">Upload Directory ( example: upload/ )</label>
        </p>
...
<input type="text" class="text" name="logo_url" id="logo_url" value="<?php echo $logo_url; ?>" size="50">
            ...
            <legend><a name="colors"></a>Colors, style</legend>
            </span>	<label for="bgcolor">Background(Hex.)</label>
                <p>
                ...
                <div class="comment4">
                <p>Gradients:<label for="menu1"></label>
                </div>
                <p>
                  <label for="menu1"></label>
                  <label for="menu1">Menu <span class="Estilo2">color1</span>(Hex.) </label><input name="menu1" TYPE="text" id="menu1"  value="<?php echo $menu1; ?>" size="20">
...
<input name="menu3" TYPE="text" id="menu3"  value="<?php echo $menu3; ?>" size="20">
            ...
            <A HREF="#" NAME="pick5" class="comment4" ID="pick5" onClick="cp2.select(document.forms[1].menu4,'pick5');return false;">Pick</A></p>
                ...
                <A HREF="#" NAME="pick6" class="comment4" ID="pick6" onClick="cp2.select(document.forms[1].fontc,'pick6');return false;">Pick</A>
