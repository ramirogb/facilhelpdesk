...
if ($authz<>'TRUE') exit;
      $query = "	SELECT * FROM users
						WHERE  username = '".$_SESSION['xcv_userna']."'"; //					LIMIT 0,1";
    ...
    <tr>
      <td class="boxborder" width="50%" valign="top" style="padding-top:5px"><table cellspacing="1" cellpadding="1" class="boxborder" align="center">
          ...
          <tr>
            ...
            <td class="text"><input name="website" id="website" value="<?php echo $row['website'] ?>" size="40" maxlength="70"
...
?>
          ...
          <tr>
            ...
            <td class="text"><input name="password_mnb" type="password" id="password_mnb" value="<?php echo $row['password'] ?>" size="40"
