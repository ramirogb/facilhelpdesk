...
{   
   ...
   if (isset($_SESSION['upgraded']) ) $c->config_set('upgraded','345fh');
...
$_SESSION['upgraded']=1;
?>
<h2 align="center" class="Estilo2">Facil HelpDesk Pro Installation </h2>
...
<p><span class="text">Fill every field of the Form, specially</span><span class="red2"> fields of  Database</span><span class="text"> and E-email. Click Submit</span><span class="red2"><strong>,</strong></span> a configuration file will be created. </p>
<p></p>
<?php
$authz='TRUE';
